 ...
 * Original template from simpleModeling.js provided on the course website. 
 */
...
//--------------------------------------------------------------------------------
function sphereFromSubdivision(numSubDivs, vertexArray, normalArray, colorArray)
{
    var numT=0;
    ...
    numT+=sphDivideTriangle(a,b,c,numSubDivs, vertexArray, normalArray, colorArray);
    numT+=sphDivideTriangle(d,c,b,numSubDivs, vertexArray, normalArray, colorArray);
    numT+=sphDivideTriangle(a,d,b,numSubDivs, vertexArray, normalArray, colorArray);
    numT+=sphDivideTriangle(a,c,d,numSubDivs, vertexArray, normalArray, colorArray);
    return numT;
}
